...
Usługi są dostępne pod adresem [https://jupyterhub.prz.edu.pl]. Domyślnie port 80 (HTTP) jest wyłączony, a ruch jest przekierowywany na port 443 (HTTPS). Wersja testowa dostępna jest na porcie 8443 pod adresem `https://{HOST}:8443/test`.
